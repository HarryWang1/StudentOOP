...
template <typename T>
void print_list(const string& name, const list<T>& tlist)  {
    cout <<"Name: "<< name <<endl;
    for(const T& t : tlist) {
        cout << t << ",";
    }
...
template <typename T>
void print_vec(const string& name, const std::vector<T>& v )  {
    cout <<"Name: "<< name <<endl;
    for(const T& t : v) {
        cout << t << ",";
    }
...
template <typename T>
void print(const string& name, const T& collection) {
    cout <<"Name: "<< name <<endl;
...
int main() {
    ...
    cout << "First odd numer in ilist is: " << * odd_iter <<endl;
    odd_iter++;
    cout << "Second odd numer in ilist is: " << * odd_iter <<endl;
    /*
     * Here we are going to pass functor `IsOdd` to `find_if()`.
     * */
    list<int>:: iterator odd_iter2 = find_if(ilist.begin(),ilist.end(),IsOdd());
    cout << "First odd numer in ilist is: " << * odd_iter2 <<endl;
    odd_iter2++;
    cout << "Second odd numer in ilist is: " << * odd_iter <<endl;
    /*
